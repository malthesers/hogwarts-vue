  ...
  <aside>
    <div class="sm:fixed w-full sm:max-w-[13rem] grid grid-cols-2 sm:grid-cols-1 gap-4 p-4 text-center">
      <div class="flex flex-col justify-center">
        <div>
          <h1 class="text-2xl sm:text-3xl mb-2">Hogwarts</h1>
          <h2 class="text-lg sm:text-xl mb-2">Class of 1991</h2>
        </div>
        <div>
      ...
      <h3 class="text-2xl col-span-2 sm:col-span-1 sm:row-start-2 sm:row-end-2">Currently Displayed: {{ students.length }}</h3>
    </div>
  </aside>
</template>
